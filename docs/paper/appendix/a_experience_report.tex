...
% TODO: improve layout: optimize column widths per page, ideally break one table, maybe make tables breakable within rows (but not supported in any kind of tables package)

...
\emph{Call graphs} and \emph{control-flow graphs} are two popular ways for displaying entities with their mutual dynamic interactions or communications~\cite{dePauw1998execution,lange1997object,walker1998visualizing,lemieux2006visualization,reiss2007visual,tramnitzke2007object,boothe2011animation,prestin2022hidden}.

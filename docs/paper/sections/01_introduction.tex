...
\begin{enumerate}
	...
	\item We describe the implementation of our prototype \tfd{} that applies this approach using a program tracer from the Squeak/\?Smalltalk environment and the \name{three.js} 3D library.
...
We make all artifacts of this work available in a public repository\footnote{\ifanon{\url{https://github.com/user/repo} (blinded)}{\url{https://github.com/LinqLover/trace4d}}}.
